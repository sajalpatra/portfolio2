  ...
  const projects = [
    {
      ...
      description: "A full stack web application built with React, Node.js, and MongoDB that allows users to track their expenses, categorize them, and visualize spending patterns through interactive charts.",
      image: "/image/expence.png", 
      link:"https://my-app-e887-4xeva43tx-sajalpatra978-gmailcoms-projects.vercel.app/"
    },
    {
      title: "Classpilot",
      description: "Ai powered classroom ecosystem for students and teachers to manage learning within the docs and notes provided by the teacher and more.",
      image: "/image/classpilot.jpeg",
      link:"https://frosthacks-localhost.vercel.app/"
    },
    {
      title: "civic-app admin dashboard webapp",
      description: "An admin dashboard for managing civic releted reports and users.",
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-14 text-slate-900">Projects</h2>
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-9">
          {projects.map((project, idx) => (
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-semibold text-sky-700 text-center">{project.title}</h3>
              <p className="mt-3 text-base leading-7 text-slate-600 text-center">{project.description}</p>
